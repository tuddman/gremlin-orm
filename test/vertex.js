    ...
    it('Should create an edge between two vertices', done => {
      Person.create(
        ...
        (err, result) => {
          let john = result;
          Person.create(
            {name: 'Jane', age: 20, dob: '12/18/1999', developer: true},
            (err, result) => {
  ...
  describe('FindAll', () => {
    it('Should find multiple vertices with matching parameters', done => {
      Person.create(
        ...
        (err, result) => {
          Person.create(
            {name: 'Jane', age: 20, dob: '12/18/1998', developer: true},
            (err, result) => {
        ...
        (err, result) => {
          ...
          Person.create(
            ...
            (err, result) => {
              ...
              john.createEdge(Knows, {duration: 1}, jane, (err, results) => {
                Person.create(
                  {name: 'Jack', age: 20, dob: '12/18/1999', developer: true},
                  (err, result) => {
                    john.createEdge(
                      Knows,
                      {duration: 2},
        ...
        (err, result) => {
          ...
          Person.create(
            ...
            (err, result) => {
              ...
              john.createEdge(Knows, {duration: 2}, jane, (err, results) => {
                Person.create(
                  {name: 'Joe', age: 20, dob: '12/18/1999', developer: true},
                  (err, result) => {
                    result.createEdge(
                      Knows,
                      {duration: 3},
        ...
        (err, result) => {
          ...
          Person.create(
            ...
            (err, result) => {
              ...
              john.createEdge(Knows, {duration: 1}, jane, (err, results) => {
                Person.create(
                  {name: 'James', age: 20, dob: '12/18/1999', developer: true},
                  (err, result) => {
                    result.createEdge(
                      Knows,
                      {duration: 1},
